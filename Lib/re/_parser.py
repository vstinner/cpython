...
_REPEATCODES = {MIN_REPEAT, MAX_REPEAT, POSSESSIVE_REPEAT}.take_frozenset()
_UNITCODES = {ANY, RANGE, IN, LITERAL, NOT_LITERAL, CATEGORY}.take_frozenset()
_SETITEMCODES = {LITERAL, CATEGORY}.take_frozenset()
