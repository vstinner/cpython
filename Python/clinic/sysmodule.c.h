...
PyDoc_STRVAR(sys_get_config__doc__,
"get_config($module, /, name)\n"
"--\n"
"\n"
"Get a configuration option.");

#define SYS_GET_CONFIG_METHODDEF    \
    {"get_config", _PyCFunction_CAST(sys_get_config), METH_FASTCALL|METH_KEYWORDS, sys_get_config__doc__},

static PyObject *
sys_get_config_impl(PyObject *module, const char *name);

static PyObject *
sys_get_config(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    #if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("get_config", "argument 'name'", "str", args[0]);
        goto exit;
    }
    ...
    return_value = sys_get_config_impl(module, name);

exit:
    return return_value;
}

PyDoc_STRVAR(sys_set_config__doc__,
"set_config($module, /, name, value)\n"
"--\n"
"\n"
"Set a configuration option.");

#define SYS_SET_CONFIG_METHODDEF    \
    {"set_config", _PyCFunction_CAST(sys_set_config), METH_FASTCALL|METH_KEYWORDS, sys_set_config__doc__},

static PyObject *
sys_set_config_impl(PyObject *module, const char *name, PyObject *value);

static PyObject *
sys_set_config(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    #if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
    ...
    static struct {
        ...
        .ob_base = PyVarObject_HEAD_INIT(&PyTuple_Type, NUM_KEYWORDS)
        .ob_item = { &_Py_ID(name), &_Py_ID(value), },
    };
    #undef NUM_KEYWORDS
    #define KWTUPLE (&_kwtuple.ob_base.ob_base)
    ...
    static const char * const _keywords[] = {"name", "value", NULL};
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "set_config",
        .kwtuple = KWTUPLE,
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("set_config", "argument 'name'", "str", args[0]);
        goto exit;
    }
    Py_ssize_t name_length;
    name = PyUnicode_AsUTF8AndSize(args[0], &name_length);
    ...
    value = args[1];
    return_value = sys_set_config_impl(module, name, value);
...
/*[clinic end generated code: output=a3d8e6f810c7fc92 input=a9049054013a1b77]*/
